...
const CardTwo = () =>{
   return(
    ...
    <h1 className="text-[#2A254B] font-clash text-1xl md:text-2xl font-normal leading-normal md:mx-36 mt-24">
    Our popular products
    </h1>

    
    <div className="flex md:mx-36  gap-3 mt-6">
        <div>
            <img src="Sofa.png" alt="chair" className="w-[670px] md:h-[300px]"/>
        ...
        <div>
            <img src="DanyChier.png" alt="chair" className="w-[350px] md:h-[300px]"/>
        ...
        <div>
            <img src="DanyChir2.png" alt="chair" className="w-[350px] md:h-[300px]" />
            <p className="text-[#2A254B] font-clash text-[20px] font-normal leading-[140%] mt-3 mb-3">The Dandy chair</p>
            <p className="text-[#2A254B] font-satoshi text-[18px] font-normal leading-[150%]">£250</p>
        </div>
